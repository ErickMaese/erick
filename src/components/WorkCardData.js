...
const ProjectCardData = [
	{
		imgsrc: Delorean,
		title: "DeLorean",
		text: "Developed under tech accelerator, OS Labs, DeLorean is Svelte's first time-traveling debugger tool that allows you to seamlessly jump from state to state.",
		view: "https://delorean-47.github.io",
		source: "https://github.com/oslabs-beta/DeLorean",
	},
	{
		imgsrc: Weather,
		title: "React Weather App",
		text: "In this project I created a React weather app, which uses an API from openweathermap to get weather information in the US",
		view: "https://erickmaese.github.io/weather-app/",
		source: "https://github.com/ErickMaese/weather-app",
	},
	{
		imgsrc: ChatZone,
		title: "ChatZone",
